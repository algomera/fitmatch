    ...
    <div class="space-y-5">
        <div>
            <div class="flex items-center justify-between">
                ...
                <x-primary-button
                    wire:click="$emit('openModal', 'onboarding.step8.modals.create-job', {{ json_encode(['user' => $user->id]) }})">
    ...
    <div class="space-y-5">
        <div>
            <div class="flex items-center justify-between">
                ...
                <x-primary-button
                    wire:click="$emit('openModal', 'onboarding.step9.modals.create-specialization', {{ json_encode(['user' => $user->id]) }})">
                    <x-heroicon-o-plus class="w-4 h-4"></x-heroicon-o-plus>
                </x-primary-button>
            </div>
            <div class="divide-y">
