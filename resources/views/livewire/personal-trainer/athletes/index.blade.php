<div class="flex justify-center lg:px-8 max-w-8xl mx-auto relative sm:px-2 xl:px-12">
    <div class="hidden lg:relative lg:block lg:flex-none">
        ...
        <div
            class="sticky h-[calc(100vh-4.5rem)] overflow-y-auto overflow-x-hidden py-6 xl:w-72 xl:pr-6">
            <h3>Lista atleti</h3>
    ...
    @if($selectedAthlete)
    <div class="min-w-0 max-w-2xl flex-auto px-4 py-6 lg:max-w-none lg:pl-6 lg:pr-0">
                ...
                <div class="pt-5 -mt-px space-y-5">
                    <div class="bg-white shadow border rounded-md col-span-2">
                        <div class="p-4 border-b">
                            <span class="text-xs text-gray-400">gg/mm/aaaa - gg/mm/aaaa</span>
                            <p class="text-lg font-bold text-fit-black mt-1">Card name</p>
                        </div>
    ...
    @else
        <div class="flex items-center justify-center min-w-0 max-w-2xl flex-auto px-4 py-6 lg:max-w-none lg:pl-6 lg:pr-0">
