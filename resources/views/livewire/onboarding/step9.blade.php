        ...
        @if($specializations->count() <= 0)
            <div class="mt-6">
                <div class="flex items-center space-x-5 mt-10">
                    ...
                    <x-primary-button wire:click="$emit('openModal', 'onboarding.step9.modals.create-specialization')">Aggiungi
                    </x-primary-button>
                </div>
            </div>
        @else
            <div>
                ...
                <div class="flex items-center space-x-5 mt-10">
                    <x-primary-button color="magenta" wire:click="$emit('openModal', 'onboarding.step9.modals.create-specialization')">Aggiungi</x-primary-button>
