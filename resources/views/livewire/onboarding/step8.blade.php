<div>
    <div class="prose prose-sm mx-auto">
        <div>
            <h1 class="pt-14 mb-2">Esperienze lavorative</h1>
        </div>
                        ...
                        <div class="not-prose py-5">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center space-x-4">
                                    ...
                                    <svg wire:click="$emit('openModal', 'onboarding.step8.modals.delete-job', {{ json_encode(['job' => $job_experience->id]) }})" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 cursor-pointer hover:text-fit-magenta">
