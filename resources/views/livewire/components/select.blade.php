        ...
        <div class="relative @if($label || isset($action)) mt-1 @endif">
            ...
            @else
                ...
                <ul
                    ...
                    x-transition
                    class="absolute z-10 mt-2 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base text-left shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm"
                    tabindex="-1">
